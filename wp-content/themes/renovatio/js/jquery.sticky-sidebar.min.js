            ...
            return function() {
                function n(t) {
                    ...
                    if (function(t, e) {
                        ...
                        }(this, n), this.options = n.extend(i, s), this.sidebar = "string" == typeof t ? document.querySelector(t) : t, void 0 === this.sidebar) throw new Error("There is no specific sidebar element.");
                    ...
                    value: function(t) {
                        if (!this._breakpoint) {
                            ...
                            if ((this.affixedType != i || t) && i) {
                                ...
                                n.eventTrigger(this.sidebar, o), "STATIC" === i ? n.removeClass(this.sidebar, this.options.stickyClass) : n.addClass(this.sidebar, this.options.stickyClass);
                                for (var r in s.outer) this.sidebar.style[r] = s.outer[r];
                                for (var a in s.inner) {
                                    var c = "number" == typeof s.inner[a] ? "px" : "";
                                    this.sidebarInner.style[a] = s.inner[a] + c
                                }
                                var p = "affixed." + i.toLowerCase().replace("viewport-", "") + e;
                                n.eventTrigger(this.sidebar, p)
                ...
                if (t) {
                    t.fn.stickySidebar = function(n) {
                        return this.each(function() {
                            var s = t(this),
                                o = t(this).data(i);
                            if (o || (o = new e(this, "object" == typeof n && n), s.data(i, o)), "string" == typeof n) {

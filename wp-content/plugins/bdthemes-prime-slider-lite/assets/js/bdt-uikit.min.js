/*! bdtUIkit 3.17.1 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */ ! function(t, e) {
    ...
    function Lt(...t) {
        ...
        s.length > 1 && (s = function(t) {
            ...
            return i => {
                const n = ">" === t[0] ? _t(t, i.currentTarget).reverse().filter((t => $t(i.target, t)))[0] : wt(i.target, t);
    ...
    function Wt(...t) {
        const [e, i, n, s, o = !1, r] = Rt(t), a = Lt(e, i, n, (t => {
            const e = !r || r(t);
            e && (a(), s(t, e))
        }), o);
        return a
    ...
    const te = "bdt-transition",
        ee = "transitionend",
        ie = "transitioncanceled";
    const ne = {
            start: function(t, e, i = 400, n = "linear") {
                return i = Math.round(i), Promise.all(D(t).map((t => new Promise(((s, o) => {
                    for (const i in e) {
                        const e = Kt(t, i);
                        "" === e && Kt(t, i, e)
                    }
                    ...
                    Wt(t, [ee, ie], (({
                        ...
                        transitionProperty: Object.keys(e).map(Qt).join(","),
    ...
    function ae(t, e, i = 200, n, s) {
        return Promise.all(D(t).map((t => new Promise(((o, r) => {
            qt(t, re);
            ...
            Wt(t, [oe, re], (({
                ...
                self: !0
            }), Kt(t, "animationDuration", `${i}ms`), it(t, e, se + (s ? "leave" : "enter")), l(e, se) && (n && it(t, `bdt-transform-origin-${n}`), s && it(t, `${se}reverse`))
        })))))
    }
    ...
    function xe(t) {
        D(t).map(gt).filter(((t, e, i) => i.indexOf(t) === e)).forEach((t => t.replaceWith(...t.childNodes)))
    }
    const ye = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
    ...
    function Be(t) {
        const e = x(t) ? A(t).getBoundingClientRect() : {
            height: Me(t),
            width: Oe(t),
            top: 0,
            left: 0
    ...
    function Ae(t) {
        ...
        return {
            top: e - P(Kt(t, "marginTop")),
            left: i - P(Kt(t, "marginLeft"))
        }
    }
    ...
    function Fe(t, e = "width", i = window, n = !1) {
        return I(t) ? L(je(t), (t => {
            ...
            return s ? function(t, e) {
                return t * P(e) / 100
            }("vh" === s ? Ve || (Re || (Re = ke("<div>"), Kt(Re, {
                height: "100vh",
                position: "fixed"
            }), Lt(window, "resize", (() => Ve = null))), pe(document.body, Re), Ve = Re.clientHeight, be(Re), Ve) : "vw" === s ? Oe(M(i)) : n ? i[`offset${a(e)}`] : Be(i)[e], t) : t
        })) : P(t)
    }
    ...
    li.prototype = {
        ...
        init() {
            let t;
            this.positions = [], this.unbind = Lt(document, "mousemove", (e => t = Gt(e))), this.interval = setInterval((() => {
                ...
                return new Promise((o => {
                    ...
                    ! function u() {
                        ...
                        if (i[0] === t && r + e < s) {
                            p = Pe(n).top - h;
                            const t = function(t) {
                                return t.ownerDocument.elementsFromPoint(0, 0).find((e => ["fixed", "sticky"].includes(Kt(e, "position")) && !e.contains(t)))
                            }(n);
                            p -= t ? Pe(t).height : 0
                        }
                        t.scrollTop = Math[e + p > 0 ? "max" : "min"](t.scrollTop, r + (e + p) * f), 1 !== f || c !== p && d-- ? (c = p, requestAnimationFrame(u)) : o()
                    }()
                }))
            }(s, f - r, t, c).then(n)
        }), (() => Promise.resolve()))()
    ...
    function Bi(t, e = !1, i = []) {
        ...
        return ~o && (s = s.slice(o)), [n].concat(s.filter((t => Kt(t, "overflow").split(" ").some((t => c(["auto", "scroll", ...i], t))) && (!e || t.scrollHeight > Di(t).height)))).reverse()
    }
    ...
    function Di(t) {
        ...
        if (b(s) && i) {
            ...
            return t = Math.round(t * n), e = Math.round(e * n), {
                height: t,
                width: e,
                top: s,
                left: o,
        ...
        for (let [t, e, i, r] of [
            ...
            const l = o[t] % 1;
            o[t] = o[e] = s[`client${a(t)}`] - (l ? l < .5 ? -l : 1 - l : 0), o[r] = o[t] + o[i]
        }
        return o
    }
    ...
    function Wi(t, e, i, n) {
        const [s, o, r, l] = Oi[n], [h] = qi(t, e), c = Di(h);
    ...
    function Vi(...t) {
        let e = {};
        for (const i of t)
            for (const [, , t, n] of Oi) e[t] = Math.max(e[t] || 0, i[t]), e[n] = Math.min(...[e[n], i[n]].filter(Boolean));
        return e
    }
    ...
    function Ui(t, e, {
        ...
        return Hi(t, e, {
            attach: {
                element: Yi(n.element, s),
                target: Yi(n.target, s)
            },
            offset: Gi(i, s)
        })
    }
    ...
    function rn(t, e, n) {
        const s = {};
        if (m(e) && (e = e.options), e.extends && (t = rn(t, e.extends, n)), e.mixins)
            for (const i of e.mixins) t = rn(t, i, n);
    ...
    function ln(t, e) {
        return t === Boolean ? _(e) : t === Number ? B(e) : "list" === t ? function(t) {
            return u(t) ? t : I(t) ? t.split(/,(?![^(]*\))/).map((t => k(t) ? B(t) : _(t.trim()))) : [t]
        }(e) : t === Object && I(e) ? an(e) : t ? t(e) : e
    }
    ...
    function un(t = {}) {
        return cn({
            handler: function(e, i) {
                ...
                for (const t of D(m(n) ? n(this) : n)) Te('[loading="lazy"]', t).slice(0, s - 1).forEach((t => tt(t, "loading")));
            ...
            handler(t) {
                ...
                Wt(document, `${Ke} ${ei} scroll`, (t => {
                    ...
                    ("scroll" !== t.type && i && n && Math.abs(e.x - n) > 100 || s && Math.abs(e.y - s) > 100) && setTimeout((() => {
                        qt(i, "swipe"), qt(i, `swipe${function(t,e,i,n){return Math.abs(t-i)>=Math.abs(e-n)?t-i>0?"Left":"Right":e-n>0?"Up":"Down"}(e.x,e.y,n,s)}`)
                    }))
                }))
            },
            ...t
    ...
    en.events = en.watch = en.observe = en.created = en.beforeConnect = en.connected = en.beforeDisconnect = en.disconnected = en.destroy = sn, en.args = function(t, e) {
        return !1 !== e && sn(e || t)
        ...
        return i ? nn(t, e, i) : e ? t ? function(i) {
            return nn(t, e, i)
        } : e : t
    };
    var bn = {
        ...
        update: {
            ...
            write({
                ...
                for (const e of t)
                    for (const i of e) at(i, this.margin, t[0] !== e), at(i, this.firstColumn, e[Xe ? e.length - 1 : 0] === i)
            },
            events: ["resize"]
        }
    };
    ...
    const xn = "bdt-transition-leave",
        yn = "bdt-transition-enter";

    function Sn(t, e, i, n = 0) {
        const s = In(e, !0),
            o = {
                opacity: 1
            },
            ...
            a = t => () => s === In(e) ? t() : Promise.reject(),
            l = a((async () => {
                it(e, xn), await Promise.all(kn(e).map(((t, e) => new Promise((s => setTimeout((() => ne.start(t, r, i / 2, "ease").then(s)), e * n)))))), nt(e, xn)
            })),
            h = a((async () => {
                const a = Me(e);
                it(e, yn), t(), Kt(yt(e), {
                ...
                const d = c.map((async (t, e) => {
                    ...
                    }(e * n), await ne.start(t, o, i / 2, "ease")
                }));
                a !== h && d.push(ne.start(e, {
                    height: h
        ...
        return rt(e, xn) ? Cn(e).then(h) : rt(e, yn) ? Cn(e).then(l).then(h) : l().then(h)
    }

    function In(t, e) {
        return e && (t.dataset.transition = 1 + In(t)), B(t.dataset.transition) || 0
    }

    function Cn(t) {
        return Promise.all(yt(t).filter(ne.inProgress).map((t => new Promise((e => Wt(t, "transitionend transitioncanceled", e))))))
    }

    function kn(t) {
        return wn(yt(t)).flat().filter(Ti)
    }
    async function Tn(t, e, i) {
        await Bn();
        let n = yt(e);
        const s = n.map((t => En(t, !0))),
            o = { ...Kt(e, ["height", "padding"]),
                display: "block"
            };
        ...
        const r = K(e, "style"),
            ...
            [l, h] = function(t, e, i) {
                const n = e.map(((t, e) => !(!gt(t) || !(e in i)) && (i[e] ? dt(t) ? _n(t) : {
                        opacity: 0
                    } : {
                        opacity: dt(t) ? 1 : 0
                    }))),
                    s = n.map(((n, s) => {
                        const o = gt(e[s]) === t && (i[s] || En(e[s]));
                        if (!o) return !1;
                        if (n) {
                            if (!("opacity" in n)) {
                                const {
        ...
        n.forEach(((t, e) => h[e] && Kt(t, h[e]))), Kt(e, o), qt(e, "scroll"), ii.flush(), await Bn();
    ...
    function En(t, e) {
        ...
        return !!dt(t) && {
            display: "",
            opacity: e ? Kt(t, "opacity") : "0",
            pointerEvents: "none",
            position: "absolute",
            zIndex: "auto" === i ? St(t) : i,
            ..._n(t)
        }
    }
    ...
    var Pn = {
        ...
        methods: {
            animate(t, e = this.$el) {
                ...
                return ("fade" === i ? Sn : "delayed-fade" === i ? (...t) => Sn(...t, 40) : i ? Tn : () => (t(), Promise.resolve()))(t, e, this.duration).catch(V)
            }
        }
    };
    const An = 9,
    ...
    var jn = {
        ...
        watch: {
            toggles(t) {
                ...
                for (const i of t) {
                    !1 !== this.selActive && at(i, this.cls, c(e, i));
                    const t = Rn(i);
        ...
        events: {
            ...
            handler(t) {
                "keydown" === t.type && t.keyCode !== Mn || wt(t.target, "a,button") && (t.preventDefault(), this.apply(t.current))
            }
        },
        methods: {
            apply(t) {
                const e = this.getState(),
                    i = qn(t, this.attrItem, this.getState());
                (function(t, e) {
                    return ["filter", "sort"].every((i => O(t[i], e[i])))
                })(e, i) || this.setState(i)
            },
            getState() {
                return this.toggles.filter((t => rt(t, this.cls))).reduce(((t, e) => qn(e, this.attrItem, t)), {
                    filter: {
                        "": ""
                    },
                    sort: []
            ...
            async setState(t, e = !0) {
                t = {
                    ...
                    sort: [],
                    ...t
                }, qt(this.$el, "beforeFilter", [this, t]);
                for (const e of this.toggles) at(e, this.cls, Vn(e, this.attrItem, t));
                await Promise.all(Te(this.target, this.$el).map((i => {
                    const n = () => {
                        (function(t, e, i) {
                            const n = function({
                                filter: t
    ...
    function Yn(t) {
        ...
        return Kt(i, {
            ...
            touchAction: "none",
            paddingRight: Oe(window) - i.clientWidth || ""
        }), () => {
            Xn = !1, e(), Kt(i, {
                overflowY: "",
                touchAction: "",
    ...
    var Jn = {
        ...
        methods: {
            async toggleElement(t, e, i) {
                try {
                    return await Promise.all(D(t).map((t => {
                        const n = S(e) ? e : !this.isToggled(t);
                        if (!qt(t, "before" + (n ? "show" : "hide"), [this])) return Promise.reject();
                        const s = (m(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? Zn : Kn : Gn)(t, n, this),
            ...
            _toggle(t, e) {
                if (!t) return;
                let i;
                e = !!e, this.cls ? (i = c(this.cls, " ") || e !== rt(t, this.cls), i && at(t, this.cls, c(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, i && (t.hidden = !e)), Te("[autofocus]", t).some((t => dt(t) ? t.focus() || !0 : t.blur())), i && qt(t, "toggled", [e, this])
            }
        }
    };
    ...
    async function Zn(t, e, {
        ...
        const [l = "reveal", h = "top"] = (null == (a = i[0]) ? void 0 : a.split("-")) || [], d = [
            ["left", "right"],
            ["top", "bottom"]
        ], u = d[c(d[0], h) ? 0 : 1], f = u[1] === h, p = ["width", "height"][d.indexOf(u)], m = `margin-${u[0]}`, g = `margin-${h}`;
        let v = Be(t)[p];
        ...
        Kt(I, {
            ...
            height: $.height,
            width: $.width,
            ...Kt(t, ["overflow", "padding", "borderTop", "borderRight", "borderBottom", "borderLeft", "borderImage", g])
        }), Kt(t, {
            padding: 0,
            border: 0,
            minWidth: 0,
        ...
        f && (Kt(t, m, S - v + x), k[m] = e ? x : S + x), !f ^ "reveal" === l && (Kt(I, m, -S + v), ne.start(I, {
            [m]: e ? 0 : -S
        }, n, o));
        try {
    ...
    var ts = {
        ...
        beforeDisconnect() {
            c(Qn, this) && this.toggleElement(this.$el, !1, !1)
        },
        events: [{
            name: "click",
            delegate() {
            ...
            self: !0,
            handler(t) {
                t.defaultPrevented || (t.preventDefault(), this.isToggled() === c(Qn, this) && this.toggle())
            }
        }, {
            name: "beforeshow",
            self: !0,
            handler(t) {
                if (c(Qn, this)) return !1;
                !this.stack && Qn.length ? (Promise.all(Qn.map((t => t.hide()))).then(this.show), t.preventDefault()) : Qn.push(this)
            }
        }, {
            name: "show",
            self: !0,
            handler() {
                this.stack && Kt(this.$el, "zIndex", P(Kt(this.$el, "zIndex")) + Qn.length);
                const t = [this.overlay && is(this), this.overlay && Yn(this.$el), this.bgClose && ns(this), this.escClose && ss(this)];
                Wt(this.$el, "hidden", (() => t.forEach((t => t && t()))), {
                    self: !0
                }), it(document.documentElement, this.clsPage)
            }
        }, {
            name: "shown",
            self: !0,
            ...
            self: !0,
            handler() {
                c(Qn, this) && Qn.splice(Qn.indexOf(this), 1), Kt(this.$el, "zIndex", ""), Qn.some((t => t.clsPage === this.clsPage)) || nt(document.documentElement, this.clsPage)
            }
        }],
        methods: {
            toggle() {
            ...
            show() {
                return this.container && gt(this.$el) !== this.container ? (pe(this.container, this.$el), new Promise((t => requestAnimationFrame((() => this.show().then(t)))))) : this.toggleElement(this.$el, !0, es)
            },
            hide() {
                return this.toggleElement(this.$el, !1, es)
            }
        }
    };
    ...
    function es(t, e, {
        ...
        return new Promise(((s, o) => Wt(t, "show hide", (() => {
            var r;
            null == (r = t._reject) || r.call(t), t._reject = o, n(t, e);
            const a = Wt(i, "transitionstart", (() => {
                    Wt(i, "transitionend transitioncancel", s, {
                        self: !0
                    }), clearTimeout(l)
                }), {
                    self: !0
                ...
                l = setTimeout((() => {
                    ...
                    return t ? h(t, "ms") ? P(t) : 1e3 * P(t) : 0
                }(Kt(i, "transitionDuration")))
        })))).then((() => delete t._reject))
    }

    function is(t) {
        return Lt(document, "focusin", (e => {
            z(Qn) === t && !$t(e.target, t.$el) && t.$el.focus()
        }))
    }

    function ns(t) {
        return Lt(document, Ge, (({
            target: e
        }) => {
            z(Qn) !== t || t.overlay && !$t(e, t.$el) || $t(e, t.panel) || Wt(document, `${Ke} ${ei} scroll`, (({
                defaultPrevented: i,
                type: n,
                target: s
            }) => {
    ...
    var os = {
        slide: {
            ...
            percent: t => rs(t),
            translate: (t, e) => [{
                transform: as(-100 * e * t)
            }, {
                transform: as(100 * e * (1 - t))
            }]
        }
    };
    ...
    const us = {
        ...
        ms = "touchend touchcancel mouseup click input scroll";
    var gs = {
        props: {
            draggable: Boolean
        },
        ...
        events: [{
            ...
            handler(t) {
                !this.draggable || !Jt(t) && function(t) {
                    return "none" !== Kt(t, "userSelect") && f(t.childNodes).some((t => 3 === t.nodeType && t.textContent.trim()))
                }(t.target) || wt(t.target, ut) || t.button > 0 || this.length < 2 || this.start(t)
            }
        }, {
            name: "dragstart",
            handler(t) {
        ...
        methods: {
            ...
            move(t) {
                ...
                let {
                    slides: i,
                    prevIndex: n
                } = this, s = Math.abs(e), o = this.getIndex(n + this.dir), r = this._getDistance(n, o);
                ...
                (this.index === n && this.prevIndex !== n || u) && qt(i[this.index], "itemshown", [this]), h && (this.prevIndex = n, this.index = o, !d && qt(a, "beforeitemhide", [this]), qt(l, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), a, !d && l), h && (!d && qt(a, "itemhide", [this]), qt(l, "itemshow", [this]))
            },
            end() {
                if (jt(document, ps, this.move, us), jt(document, ms, this.end, fs), this.dragging)
    ...
    function vs(t, e = "update") {
        t._connected && t._updates.length && (t._queued || (t._queued = new Set, ii.read((() => {
            t._connected && function(t, e) {
                for (const {
                    ...
                    let o;
                    i && (o = i.call(t, t._data, e), o && v(o) && p(t._data, o)), n && !1 !== o && ii.write((() => {
        ...
        t._hasComputed && (function(t, e) {
            ...
            read: () => function(t, e) {
                for (const {
                        ...
                        handler: s,
                        immediate: o = !0
                    } of t._watches)(t._initial && o || i(e, n) && !O(e[n], t[n])) && s.call(t, t[n], e[n]);
                t._initial = !1
            }(t, xs(t)),
            events: ["resize", "computed"]
        }), ys || (Ss = new Set, ys = new MutationObserver((() => {
            for (const t of Ss) vs(t, "computed")
        })), ys.observe(document, {
            subtree: !0,
            childList: !0
        })), Ss.add(t))
    ...
    function Is(t, e, i) {
        ...
        s = m(s) ? s.call(t, t) : s || t.$el, u(s) ? s.forEach((n => Is(t, { ...e,
            el: n
        }, i))) : !s || h && !h.call(t) || t._events.push(Lt(s, n, l ? I(l) ? l : l.call(t, t) : null, I(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: c
        }))
    ...
    function ks(t, e) {
        ...
        m(s) && !i(t, h) && ws(t, h, (() => s.call(t, t))), o = I(o) ? t[o] : o.bind(t), m(r) && (r = r.call(t, t));
        const c = n(i(t, h) ? t[h] : s, o, r, l);
        m(s) && u(t[h]) && c.unobserve && bs(t, {
            handler: Ts(c),
            immediate: !1
        }, h), Cs(t, c)
    }
    ...
    function Ps(t) {
        t._connected || (function(t) {
            const e = Es(t.$options);
            for (let i in e) E(e[i]) || (t.$props[i] = e[i]);
            const i = [t.$options.computed, t.$options.methods];
            for (let n in t.$props) n in e && _s(i, n) && (t[n] = t.$props[n])
        }(t), Bs(t, "beforeConnect"), t._connected = !0, function(t) {
            t._events = [];
            for (const e of t.$options.events || [])
                if (i(e, "handler")) Is(t, e);
                else
                    for (const i in e) Is(t, e[i], i)
        }(t), function(t) {
            t._data = {}, t._updates = [...t.$options.update || []]
        }(t), function(t) {
            t._watches = [];
            for (const e of t.$options.watch || [])
                for (const [i, n] of Object.entries(e)) bs(t, n, i);
            t._initial = !0
        }(t), function(t) {
            t._observers = [];
            for (const e of t.$options.observe || [])
                if (i(e, "handler")) ks(t, e);
                else
                    for (const i of e) ks(t, i)
        }(t), function(t) {
            const {
                $options: e,
                $props: i
            ...
            c.observe(a, {
                attributes: !0,
                attributeFilter: h.concat(h.map((t => `data-${t}`)))
            }), Cs(t, c)
        }(t), $s(t), Bs(t, "connected"), vs(t))
    }

    function As(t) {
        t._connected && (Bs(t, "beforeDisconnect"), function(t) {
            ...
            null == Ss || Ss.delete(t), xs(t)
        }(t), Bs(t, "disconnected"), t._connected = !1)
    }
    let Ds = 0;
    ...
    function Ms(t, e = {}) {
        e.data = function({
                ...
                return t
            }(e, t.constructor.options), t.$options = rn(t.constructor.options, e, t), t.$props = {}, t._uid = Ds++,
            function(t) {
                const {
                    data: e = {}
                } = t.$options;
            ...
            function(t) {
                ...
                if (t._computed = {}, e)
                    for (const i in e) ws(t, i, e[i])
            }(t), Bs(t, "created"), e.el && t.$mount(e.el)
    }
    const Os = function(t) {
        Ms(this, t)
    };
    Os.util = Zi, Os.options = {}, Os.version = "3.17.1";
    const Ns = "bdt-",
        zs = "__uikit__",
        Hs = {};
    ...
    function Fs(t, e) {
        var i;
        const n = Ns + s(t);
        if (!e) return v(Hs[n]) && (Hs[n] = Os.extend(Hs[n])), Hs[n];
        t = r(t), Os[t] = (e, i) => Ls(t, e, i);
        const o = v(e) ? { ...e
        } : e.options;
        return o.id = n, o.name = t, null == (i = o.install) || i.call(o, Os, o, t), Os._initialized && !o.functional && requestAnimationFrame((() => Ls(t, `[${n}],[data-${n}]`))), Hs[n] = o
    }
    ...
    function qs(t, e) {
        ...
        for (const i of xt(t).reverse()) Vs(i, e);
        Ce(t, (t => Vs(t, e)))
    }

    function Vs(t, e) {
        const i = js(t);
        for (const t in i) vs(i[t], e)
    }

    function Rs(t, e = t.$el, i = "") {
        if (e.id) return e.id;
        let n = `${t.$options.id}-${t._uid}${i}`;
        return ke(`#${n}`) && (n = Rs(t, e, `${i}-2`)), n
    }
    var Us = {
            i18n: {
                next: "Next slide",
                ...
                navItems(t) {
                    for (const e of t) {
                        ...
                        if (k(t)) {
                            const e = B(t),
                                o = this.slides[e];
                            o && (o.id || (o.id = Rs(this, o, `-item-${t}`)), s = o.id), n = this.t("slideX", P(t) + 1), K(i, "role", "tab")
                        } else this.list && (this.list.id || (this.list.id = Rs(this, this.list, "-items")), s = this.list.id), n = this.t(t);
                        K(i, {
                            "aria-controls": s,
                            "aria-label": K(i, "aria-label") || n
                        })
                    }
                },
                slides(t) {
            ...
            events: [{
                ...
                handler(t) {
                    wt(t.target, "a,button") && ("click" === t.type || t.keyCode === Mn) && (t.preventDefault(), this.show(et(t.current, this.attrItem)))
                }
            }, {
                name: "itemshow",
                handler: "updateNav"
                ...
                handler(t) {
                    ...
                    let n = i === Nn ? 0 : i === On ? "last" : i === zn ? "previous" : i === Fn ? "next" : -1;
            ...
            methods: {
                updateNav() {
                    ...
                    for (const e of this.navItems) {
                        ...
                        if (k(i)) {
                            const s = B(i) === t;
                            at(e, this.clsActive, s), K(n, {
                                "aria-selected": s,
                                tabindex: s ? null : -1
                            }), s && n && bt(gt(e), ":focus-within") && n.focus()
                        } else at(e, "bdt-invisible", this.finite && ("previous" === i && 0 === t || "next" === i && t >= this.maxIndex))
                    }
                }
            }
        },
            ...
            methods: {
                show(t, e = !1) {
                    ...
                    if (this.dir = function(t, e) {
                        ...
                        }(t, r), this.prevIndex = r, this.index = l, a && !qt(a, "beforeitemhide", [this]) || !qt(h, "beforeitemshow", [this, a])) return this.index = this.prevIndex, void o();
            ...
            data: {
                ...
                Transitioner: function(t, e, i, {
                    ...
                    return {
                        ...
                        show(n, o = 0, r) {
                            const a = r ? "linear" : s;
                            return n -= Math.round(n * q(o, -1, 1)), this.translate(o), hs(e, "itemin", {
                                percent: o,
                                duration: n,
                                timing: a,
                                dir: i
                                ...
                                h || (h = i), Promise.all([ne.start(e, l[1], n, a), ne.start(t, l[0], n, a)]).then((() => {
                                    this.reset(), h()
                                }), V)
                            }))
                        },
                        ...
                        translate(n) {
                            this.reset();
                            const s = r(n, i);
                            Kt(e, s[1]), Kt(t, s[0]), hs(e, "itemtranslatein", {
                                percent: n,
                                dir: i
                            }), hs(t, "itemtranslateout", {
                                percent: 1 - n,
                                dir: i
                            })
                        },
        ...
        Zs = {
            ...
            events: [{
                ...
                handler({
                    ...
                    let e = -1;
                    t === zn ? e = "previous" : t === Fn ? e = "next" : t === Nn ? e = 0 : t === On && (e = "last"), ~e && this.show(e)
                }
            }, {
                name: "beforeitemshow",
                handler(t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleElement(this.$el, !0, !1), this.animation = Gs.scale, nt(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler() {
                ...
                async handler(t, e) {
                    ...
                    } else if ("iframe" === n || i.match(/\.(html|php)($|\?)/i)) this.setItem(e, Ks("iframe", {
                        src: i,
                        allowfullscreen: "",
                        class: "bdt-lightbox-iframe",
                        ...r
                    }));
                    else if (a = i.match(/\/\/(?:.*?youtube(-nocookie)?\..*?(?:[?&]v=|\/shorts\/)|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) this.setItem(e, Ks("iframe", {
            ...
            methods: {
                ...
                showControls() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), it(this.$el, "bdt-active", "bdt-transition-active")
                },
                hideControls() {
                    nt(this.$el, "bdt-active", "bdt-transition-active")
                }
            }
        };
    ...
    var Qs = {
        install: function(t, e) {
            t.lightboxPanel || t.component("lightboxPanel", Zs), p(e.props, t.component("lightboxPanel").options.props)
        },
        props: {
            toggle: String
        },
        ...
        methods: {
            show(t) {
                const e = j(this.toggles.map(to), "source");
                if (x(t)) {
                    const {
                        source: i
                    } = to(t);
    ...
    var eo = {
        ...
        created() {
            ...
            (!e || !dt(e)) && (e = pe(this.container, `<div class="${this.clsContainer} ${t}"></div>`)), this.$mount(pe(e, `<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert"> <a href class="${this.clsClose}" data-bdt-close></a> <div>${this.message}</div> </div>`))
        },
        async connected() {
            const t = P(Kt(this.$el, this.marginProp));
            await ne.start(Kt(this.$el, this.startProps), {
                opacity: 1,
                [this.marginProp]: t
        ...
        methods: {
            async close(t) {
                this.timer && clearTimeout(this.timer), t || await ne.start(this.$el, this.startProps), (t => {
                    const e = gt(t);
                    qt(t, "close", [this]), be(t), null != e && e.hasChildNodes() || be(e)
                })(this.$el)
            }
        }
    };
    var io = {
        ...
        connected() {
            const t = function(t, e) {
                if (I(t))
                    if (l(t, "@")) t = P(Kt(e, `--bdt-breakpoint-${t.substr(1)}`));
    ...
    function no(t) {
        return Math.ceil(Math.max(0, ...Te("[stroke]", t).map((t => {
            try {
    ...
    const so = {
            ...
            opacity: function(t, e, i) {
                return 1 === i.length && i.unshift(xo(e, t, "")), i = go(i), (e, n) => {
                    e[t] = bo(i, n)
                }
            },
            stroke: function(t, e, i) {
                ...
                const n = $o(i),
                    s = no(e);
                return (i = go(i.reverse(), (t => (t = P(t), "%" === n ? t * s / 100 : t)))).some((([t]) => t)) ? (Kt(e, "strokeDasharray", s), (t, e) => {
                    t.strokeDashoffset = bo(i, e)
                }) : V
            },
            bgx: co,
            bgy: co
    ...
    var ro = {
        mixins: [io],
        props: yo(oo(so), "list"),
        data: yo(oo(so), void 0),
        computed: {
            props(t, e) {
                const i = {};
                for (const e in t) e in so && !E(t[e]) && (i[e] = t[e].slice());
                const n = {};
                for (const t in i) n[t] = so[t](t, e, i[t], i);
                return n
            }
        },
        events: {
    ...
    function ao(t, e, i) {
        ...
        return "x" === t || "y" === t ? (t = `translate${a(t)}`, n = t => P(P(t).toFixed("px" === s ? 0 : 6))) : "scale" === t && (s = "", n = t => {
            var i;
            return $o([t]) ? Fe(t, "width", e, !0) / e["offset" + (null != (i = t.endsWith) && i.call(t, "vh") ? "Height" : "Width")] : P(t)
        }), 1 === i.length && i.unshift("scale" === t ? 1 : 0), i = go(i, n), (e, n) => {
            e.transform = `${e.transform||""} ${t}(${bo(i,n)}${s})`
        }
    }

    function lo(t, e, i) {
        return 1 === i.length && i.unshift(xo(e, t, "")), i = go(i, (t => function(t, e) {
            return xo(t, "color", e).split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(P)
        }(e, t))), (e, n) => {
            const [s, o, r] = vo(i, n), a = s.map(((t, e) => (t += r * (o[e] - t), 3 === e ? P(t) : parseInt(t, 10)))).join(",");
            e[t] = `rgba(${a})`
        }
    }
    ...
    function co(t, e, i, n) {
        ...
        const r = {};
        for (const t of o) r[t] = uo(e, t);
        return fo(o, r, n)
    }

    function uo(t, e) {
        return xo(t, `background-position-${e.substr(-1)}`, "")
    }
    ...
    function $o(t, e) {
        var i;
        for (const e of t) {
            const t = null == (i = e.match) ? void 0 : i.call(e, wo);
            if (t) return t[1]
        }
        return e
    }
    ...
    function Io(t) {
        return t ? "offsetTop" in t ? t : Io(gt(t)) : document.documentElement
    }
    var Co = {
            update: {
                write() {
    ...
    function Eo(t) {
        return Math.max(0, _o(t) - Be(t).width)
    }
    ...
    var Do = {
        ...
        data: {
            ...
            Transitioner: function(t, e, i, {
                ...
                const r = t ? To(t, o, n) : To(e, o, n) + Be(e).width * i,
                    a = e ? To(e, o, n) : r + Be(t).width * i * (Xe ? -1 : 1);
                let l;
                return {
                    dir: i,
                    show(e, n = 0, r) {
                        const h = r ? "linear" : s;
                        return e -= Math.round(e * q(n, -1, 1)), this.translate(n), n = t ? n : q(n, 0, 1), Ao(this.getItemIn(), "itemin", {
                            percent: n,
                            duration: e,
                            timing: h,
                            dir: i
                        }), t && Ao(this.getItemIn(!0), "itemout", {
                            percent: 1 - n,
                            duration: e,
                            timing: h,
                            dir: i
                    ...
                    translate(n) {
                        ...
                        Kt(o, "transform", as(q(s - s * n - a, -_o(o), Be(o).width) * (Xe ? -1 : 1), "px"));
                        ...
                        for (const s of yt(o)) {
                            const a = c(r, s),
                                d = s === l,
                                u = s === h;
                            Ao(s, "itemtranslate" + (d || !u && (a || i * (Xe ? -1 : 1) == -1 ^ Bo(s, o) > Bo(t || e)) ? "in" : "out"), {
                                dir: i,
                    ...
                    getActives: () => Po(o, To(t || e, o, n))
                }
            }
        },
        computed: {
            avgWidth() {
                return _o(this.list) / this.length
            },
            finite({
                finite: t
            }) {
                return t || function(t, e) {
                    ...
                    if (!e) return Math.ceil(_o(t)) < Math.trunc(i + function(t) {
                    ...
                    for (const t in n) {
                        ...
                        if (r > L(n.filter((t => !o.has(t))), (t => Be(t).width))) return !0
                    }
                    return !1
        ...
        events: {
            beforeitemshow(t) {
                ...
                this.duration = Ys(this.avgWidth / this.velocity) * (Be(this.slides[i]).width / this.avgWidth), this.reorder()
            },
            itemshow() {
        ...
        methods: {
            ...
            getAdjacentSlides() {
                const {
                    width: t
                } = Be(this.list), e = -t, i = 2 * t, n = Be(this.slides[this.index]).width, s = this.center ? t / 2 - n / 2 : 0, o = new Set;
                for (const t of [-1, 1]) {
                    let r = s + (t > 0 ? n : 0),
                        a = 0;
                    do {
    ...
    var Mo = {
        ...
        events: [{
            ...
            handler({
                ...
                ii.read((() => {
                    if (!this.matchMedia) return;
                    const o = this.getCss(No(t, s, e)),
                        r = this.getCss(Oo(t) ? .5 : s > 0 ? 1 : 0);
                    ii.write((() => {
    ...
    var zo = { ...os,
        ...
        pull: {
            ...
            percent: (t, e, i) => i < 0 ? 1 - rs(e) : rs(t),
            translate: (t, e) => e < 0 ? [{
                transform: as(30 * t),
                zIndex: -1
            }, {
                transform: as(-100 * (1 - t)),
                zIndex: 0
            }] : [{
                transform: as(100 * -t),
                zIndex: 0
    ...
    const Ho = Ue && CSS.supports("aspect-ratio", "1/1");
    var Fo = {
            mixins: [Ki, Js, Co, ko],
            props: {
                ratio: String,
            ...
            update: {
                read() {
                    ...
                    return e = e * this.list.offsetWidth / t || 0, this.minHeight && (e = Math.max(this.minHeight, e)), this.maxHeight && (e = Math.min(this.maxHeight, e)), {
                        height: e - ze(this.list, "height", "content-box")
                    }
                },
                write({
                    height: t
                                ...
                                const n = yt(t),
                                    s = n.some(((t, e) => {
                                        ...
                                        return n.slice(e + 1).some((t => {
                                            const e = t.getBoundingClientRect();
                                            return !Wo([i.left, i.right], [e.left, e.right])
                                        }))
                                    }));
                                return i && be(e), s
                            }(t, i) || s < r.top + r.height / 2 ? e : e.nextElementSibling;
                            const a = i.getBoundingClientRect(),
                                l = Wo([r.top, r.bottom], [a.top, a.bottom]),
            ...
            methods: {
                init(t) {
                    const {
                        ...
                        button: i,
                        defaultPrevented: n
                    } = t, [s] = this.items.filter((t => $t(e, t)));
                    !s || n || i > 0 || ft(e) || $t(e, `.${this.clsNoDrag}`) || this.handle && !$t(e, this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = s, this.origin = {
                        target: e,
                        index: St(s),
                        ...this.pos
                    }, Lt(document, Ze, this.move), Lt(document, Ke, this.end), this.threshold || this.start(t))
                },
                start(t) {
                    this.drag = function(t, e) {
                        ...
                        return pe(t, i), Kt(i, "margin", "0", "important"), Kt(i, {
                            boxSizing: "border-box",
                            width: e.offsetWidth,
                            height: e.offsetHeight,
                            padding: Kt(e, "padding")
                        }), Me(i.firstElementChild, Me(e.firstElementChild)), i
                    ...
                    p(this.origin, {
                        ...
                        }), it(this.drag, this.clsDrag, this.clsCustom), it(this.placeholder, this.clsPlaceholder), it(this.items, this.clsItem), it(document.documentElement, this.clsDragState), qt(this.$el, "start", [this, this.placeholder]),
                        function(t) {
                            let e = Date.now();
                            jo = setInterval((() => {
                                let {
                                ...
                                e = Date.now(), Bi(document.elementFromPoint(i, t.y)).reverse().some((t => {
                                    let {
                                        scrollTop: e,
                                        scrollHeight: i
                                    } = t;
                ...
                move(t) {
                    ...
                    this === t ? this.origin.index !== St(this.placeholder) && qt(this.$el, "moved", [this, this.placeholder]) : (qt(t.$el, "added", [t, this.placeholder]), qt(this.$el, "removed", [this, this.placeholder])), qt(this.$el, "stop", [this, this.placeholder]), be(this.drag), this.drag = null;
                    for (const {
                            clsPlaceholder: t,
                            clsItem: e
                        } of this.touched)
                        for (const i of this.touched) nt(i.items, t, e);
        ...
        methods: {
            positionAt(t, e, i) {
                ...
                const s = [this.flip && "flip", this.shift && "shift"],
                    o = {
                        element: [this.inset ? this.dir : He(this.dir), this.align],
            ...
            getPositionOffset(t) {
                return Fe(!1 === this.offset ? Kt(t, "--bdt-position-offset") : this.offset, "x" === this.axis ? "width" : "height", t) * (c(["left", "top"], this.dir) ? -1 : 1) * (this.inset ? -1 : 1)
            },
            getShiftOffset(t) {
                return "center" === this.align ? 0 : Fe(Kt(t, "--bdt-position-shift-offset"), "y" === this.axis ? "width" : "height", t) * (c(["left", "top"], this.align) ? 1 : -1)
            },
            getViewportOffset: t => Fe(Kt(t, "--bdt-position-viewport-offset"))
        }
    };
    var Vo = {
        mixins: [Un, Jn, qo],
        ...
        beforeConnect() {
            var t;
            this.id = Rs(this, {}), this._hasTitle = Q(this.$el, "title"), K(this.$el, {
                title: "",
                "aria-describedby": this.id
            }), mt(t = this.$el) || K(t, "tabindex", "0")
        },
        disconnected() {
        ...
        methods: {
            ...
            async _show() {
                this.tooltip = pe(this.container, `<div id="${this.id}" class="bdt-${this.$options.name}" role="tooltip"> <div class="bdt-${this.$options.name}-inner">${this.title}</div> </div>`), Lt(this.tooltip, "toggled", ((t, e) => {
                    if (!e) return;
                    ...
                    const o = [Wt(document, `keydown ${Ge}`, this.hide, !1, (t => t.type === Ge && !$t(t.target, this.$el) || "keydown" === t.type && t.keyCode === Dn)), Lt([document, ...Ai(this.$el)], "scroll", i, {
                        passive: !0
                    })];
                    Wt(this.tooltip, "hide", (() => o.forEach((t => t()))), {
                        self: !0
                    })
    ...
    var Ro = {
        ...
        events: {
            ...
            drop(t) {
                ...
                null != e && e.files && (nt(this.$el, this.clsDragover), this.upload(e.files))
            },
            dragenter(t) {
                Xo(t)
            },
            dragover(t) {
                Xo(t), it(this.$el, this.clsDragover)
            },
            dragleave(t) {
                Xo(t), nt(this.$el, this.clsDragover)
            }
        },
        methods: {
            async upload(t) {
                ...
                for (const e of t) {
                    ...
                    if (this.allow && !Uo(this.allow, e.name)) return void this.fail(this.t("invalidName", this.allow));
                    if (this.mime && !Uo(this.mime, e.type)) return void this.fail(this.t("invalidMime", this.mime))
                }
                            ...
                            function(t, e) {
                                ...
                                return Promise.resolve().then((() => i.beforeSend(i))).then((() => function(t, e) {
                                    return new Promise(((i, n) => {
                                        ...
                                        })), Lt(s, "error", (() => n(p(Error("Network Error"), {
                                            xhr: s
                                        })))), Lt(s, "timeout", (() => n(p(Error("Network Timeout"), {
                                            xhr: s
                                        })))), s.send(e.data)
                                    }))
                                }(t, i)))
    ...
    function Go(t) {
        qt(document, "uikit:init", t), document.body && Ce(document.body, Qo), new MutationObserver((t => t.forEach(Zo))).observe(document, {
            subtree: !0,
            childList: !0
        }), new MutationObserver((t => t.forEach(Ko))).observe(document, {
            subtree: !0,
            attributes: !0
        }), t._initialized = !0
    }
    ...
    function Zo({
        ...
        for (const e of t) Ce(e, Qo);
        for (const t of e) Ce(t, tr)
    }
    ...
    function Ko({
        ...
        const n = er(e);
        if (n) {
            if (Q(t, e)) return void Ls(n, t);
            null == (i = Ws(t, n)) || i.$destroy()
        }
    }

    function Qo(t) {
        const e = js(t);
        for (const i in js(t)) Ps(e[i]);
    ...
    function er(t) {
        ...
        let e;
        t.component = Fs, t.getComponents = js, t.getComponent = Ws, t.update = qs, t.use = function(t) {
    ...
    })(Os), (Yo = Os).prototype.$mount = function(t) {
        const e = this;
        (function(t, e) {
            t[zs] || (t[zs] = {}), t[zs][e.$options.name] = e
        })(t, e), e.$options.el = t, $t(t, document) && Ps(e)
    }, Yo.prototype.$destroy = function(t = !1) {
        const e = this,
            {
                el: i
            } = e.$options;
        i && As(e), Bs(e, "destroy"),
            function(t, e) {
                var i;
                null == (i = t[zs]) || delete i[e.$options.name], T(t[zs]) || delete t[zs]
            }(i, e), t && be(e.$el)
    }, Yo.prototype.$create = Ls, Yo.prototype.$emit = function(t) {
        vs(this, t)
    }, Yo.prototype.$update = function(t = this.$el, e) {
        qs(t, e)
    }, Yo.prototype.$reset = function() {
        As(this), Ps(this)
    }, Yo.prototype.$getComponent = Ws, Object.defineProperties(Yo.prototype, {
        $el: {
            get() {
                return this.$options.el
            }
        },
        $container: Object.getOwnPropertyDescriptor(Yo, "container")
    });
    var ir = {
        mixins: [Ki, Jn],
        props: {
        ...
        watch: {
            ...
            contents(t) {
                for (const e of t) {
                    const t = rt(this.items.find((t => $t(e, t))), this.clsOpen);
                    nr(e, !t)
                }
                this.$emit()
            }
        ...
        events: [{
            ...
            async handler(t) {
                var e;
                "keydown" === t.type && t.keyCode !== Mn || (t.preventDefault(), null == (e = this._off) || e.call(this), this._off = function(t) {
                    const e = Pi(t, !0);
                    let i;
                    return function n() {
                ...
                }(t.target), await this.toggle(St(this.toggles, t.current)), this._off())
            }
        }, {
            name: "shown hidden",
            self: !0,
        ...
        update() {
            ...
            for (const e in this.items) {
                const i = this.toggles[e],
                    n = this.contents[e];
                if (!i || !n) continue;
                i.id = Rs(this, i, `-title-${e}`), n.id = Rs(this, n, `-content-${e}`);
                const s = c(t, this.items[e]);
                K(i, {
                    role: ce(i, "a") ? "button" : null,
                    "aria-controls": n.id,
                    "aria-expanded": s,
        ...
        methods: {
            toggle(t, e) {
                ...
                if (!this.multiple && !c(n, i[0]) && (i = i.concat(n)), !(!this.collapsible && n.length < 2 && c(n, t))) return Promise.all(i.map((t => this.toggleElement(t, !c(n, t), ((t, i) => {
                    if (at(t, this.clsOpen, i), !1 !== e && this.animation) return async function(t, e, {
                        content: i,
                        duration: n,
                        velocity: s,
                        transition: o
                        ...
                        await ne.cancel(a), nr(i, !1);
                        const h = L(["marginTop", "marginBottom"], (t => Kt(i, t))) + Be(i).height,
                            c = l / h;
                        n = (s * h + n) * (e ? 1 - c : c), Kt(a, "height", l), await ne.start(a, {
                            height: e ? h : 0
                        }, n, o), xe(i), delete t._wrapper, e || nr(i, !0)
                    }(t, i, this);
                    nr(ke(this.content, t), !i)
                })))))
            }
        }
    };
    ...
    var sr = {
        ...
        methods: {
            async close() {
                await this.toggleElement(this.$el, !1, or), this.$destroy(!0)
            }
        }
    };
    ...
    function or(t, e, {
        ...
        return Kt(t, "height", o), ne.start(t, {
            height: 0,
            marginTop: 0,
            marginBottom: 0,
            paddingTop: 0,
    ...
    var rr = {
            ...
            connected() {
                this.inView = "inview" === this.autoplay, this.inView && !Q(this.$el, "preload") && (this.$el.preload = "none"), ce(this.$el, "iframe") && !Q(this.$el, "allow") && (this.$el.allow = "autoplay"), this.automute && vi(this.$el)
            },
            observe: [cn({
                args: {
                    intersecting: !1
    ...
    function lr(t) {
        for (; t = gt(t);)
            if ("static" !== Kt(t, "position")) return t
    }
    let hr;
    var cr = {
        mixins: [Un, qo, Jn],
        ...
        computed: {
            boundary: ({
                ...
                boundaryX: e,
                boundaryY: i
            }, n) => [kt(e || t, n) || window, kt(i || t, n) || window],
            target({
                target: t,
                targetX: e,
                targetY: i
        ...
        connected() {
            it(this.$el, "bdt-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = function(t) {
                const {
                    $el: e
                } = t.$create("toggle", kt(t.toggle, t.$el), {
                    target: t.$el,
                    mode: t.mode
                });
        ...
        disconnected() {
            this.isActive() && (this.hide(!1), hr = null), Kt(this.$el, this._style)
        },
        observe: un({
            target: ({
                toggle: t,
        ...
        events: [{
            ...
            self: !0,
            handler() {
                hr = this, this.tracker.init(), K(this.targetEl, "aria-expanded", !0);
                const t = [dr(this), fr(this), mr(this), this.autoUpdate && ur(this), this.closeOnScroll && pr(this), !this.bgScroll && Yn(this.$el)];
                Wt(this.$el, "hide", (() => t.forEach((t => t && t()))), {
                    self: !0
                })
            }
        }, {
            ...
            handler({
                ...
                this.$el === t ? (hr = this.isActive() ? null : hr, this.tracker.cancel(), K(this.targetEl, "aria-expanded", null)) : hr = null === hr && $t(t, this.$el) && this.isToggled() ? this : hr
            }
        }],
        update: {
            write() {
        ...
        methods: {
            show(t = this.targetEl, e = !0) {
                if (this.isToggled() && t && this.targetEl && t !== this.targetEl && this.hide(!1, !1), this.targetEl = t, this.clearTimers(), !this.isActive()) {
                    if (hr) {
                        if (e && hr.isDelaying) return void(this.showTimer = setTimeout((() => bt(t, ":hover") && this.show()), 10));
                        let i;
                        for (; hr && i !== hr && !$t(this.$el, hr.$el);) i = hr, hr.hide(!1, !1)
                    }
            ...
            position() {
                nt(this.$el, "bdt-drop-stack"), Kt(this.$el, this._style), this.$el.hidden = !0;
                ...
                for (const [n, [s, o]] of i) this.axis !== s && c([s, !0], this.stretch) && Kt(this.$el, {
                    [o]: Math.min(Pe(this.boundary[n])[o], t[n][o] - 2 * e),
                    [`overflow-${s}`]: "auto"
                });
                const n = t[0].width - 2 * e;
                this.$el.hidden = !1, Kt(this.$el, "maxWidth", ""), this.$el.offsetWidth > n && it(this.$el, "bdt-drop-stack"), Kt(this.$el, "maxWidth", n), this.positionAt(this.$el, this.target, this.boundary);
                for (const [n, [s, o, r, a]] of i)
                    if (this.axis === s && c([s, !0], this.stretch)) {
                        const i = Math.abs(this.getPositionOffset(this.$el)),
                            ...
                            h = Pe(this.$el);
                        Kt(this.$el, {
                            [o]: (l[r] > h[r] ? l[this.inset ? a : r] - Math.max(Pe(this.boundary[n])[r], t[n][r] + e) : Math.min(Pe(this.boundary[n])[a], t[n][a] - e) - l[this.inset ? r : a]) - i,
                            [`overflow-${s}`]: "auto"
    ...
    function ur(t, e = (() => t.$emit())) {
        return Lt([document, ...Ai(t.$el)], "scroll", e, {
            passive: !0
        })
    }
    ...
    function fr(t) {
        return Lt(document, "keydown", (e => {
            e.keyCode === Dn && t.hide(!1)
        }))
    }

    function pr(t) {
        return ur(t, (() => t.hide(!1)))
    }
    ...
    function mr(t) {
        return Lt(document, Ge, (({
            ...
            $t(e, t.$el) || Wt(document, `${Ke} ${ei} scroll`, (({
                defaultPrevented: i,
                type: n,
                target: s
            }) => {
    ...
    var gr = {
        ...
        watch: {
            dropbar(t) {
                it(t, "bdt-dropbar", "bdt-dropbar-top", this.clsDropbar, `bdt-${this.$options.name}-dropbar`)
            },
            dropdowns() {
        ...
        events: [{
            ...
            handler(t) {
                ...
                n === Ln && (null == s ? void 0 : s.targetEl) === i && (t.preventDefault(), null == (e = ke(pt, s.$el)) || e.focus()), vr(t, this.items, s)
            }
        }, {
            name: "keydown",
            el() {
            ...
            handler(t) {
                ...
                let o = -1;
                if (n === Nn ? o = 0 : n === On ? o = "last" : n === Hn ? o = "previous" : n === Ln ? o = "next" : n === Dn && (null == (e = s.targetEl) || e.focus()), ~o) {
                    t.preventDefault();
                    const e = Te(pt, i);
                    e[G(o, e, d(e, (t => bt(t, ":focus"))))].focus()
                }
                vr(t, this.items, s)
            }
        }, {
            ...
            handler({
                ...
                const e = this.getDropdown(t),
                    i = () => {
                        const e = xt(t, `.${this.clsDrop}`).concat(t).map((t => Pe(t))),
                            i = Math.min(...e.map((({
                                top: t
                            }) => t))),
                            n = Math.max(...e.map((({
        ...
        methods: {
            getActive() {
                var t;
                return c(this.dropdowns, null == (t = hr) ? void 0 : t.$el) && hr
            },
            async transitionTo(t, e) {
                const {
                    dropbar: i
                } = this, n = Me(i);
                e = n < t && e, await ne.cancel([e, i]), Kt(e, "clipPath", `polygon(0 0,100% 0,100% ${n}px,0 ${n}px)`), Me(i, n), await Promise.all([ne.start(i, {
                    height: t
                }, this.duration), ne.start(e, {
                    clipPath: `polygon(0 0,100% 0,100% ${t}px,0 ${t}px)`
                }, this.duration).finally((() => Kt(e, {
                    clipPath: ""
                })))]).catch(V)
            },
            getDropdown(t) {
    ...
    function vr(t, e, i) {
        ...
        let l = -1;
        a === Nn ? l = 0 : a === On ? l = "last" : a === zn ? l = "previous" : a === Fn ? l = "next" : a === An && (null == (n = i.targetEl) || n.focus(), null == (s = i.hide) || s.call(i, !1)), ~l && (t.preventDefault(), null == (o = i.hide) || o.call(i, !1), e[G(l, e, e.indexOf(i.targetEl || r))].focus())
    }
    var br = {
            mixins: [Ki],
            args: "target",
            ...
            update() {
                ...
                const s = ft(e) ? "value" : "textContent",
                    o = e[s],
                    r = null != (t = i.files) && t[0] ? i.files[0].name : bt(i, "select") && (n = Te("option", i).filter((t => t.selected))[0]) ? n.textContent : i.value;
                o !== r && (e[s] = r)
            },
            events: [{
                name: "change",
        ...
        wr = {
            ...
            connected() {
                this.masonry && it(this.$el, "bdt-flex-top", "bdt-flex-wrap-top")
            },
            observe: pn({
                filter: ({
                    parallax: t,
            ...
            update: [{
                ...
                read(t) {
                    ...
                    if (n = Math.max(0, Fe(n)), !(i || n || s) || $r(e) || e[0].some(((t, i) => e.some((e => e[i] && e[i].offsetWidth !== t.offsetWidth))))) return t.translates = t.scrollColumns = !1;
                    ...
                    i ? [r, a] = function(t, e, i) {
                        ...
                        for (let a of t) {
                            ...
                            for (const l in a) {
                                ...
                                xr(n, d, a[l]), xr(s, d, [(d - l) * h * (Xe ? -1 : 1), o[d] - r]), o[d] += c + e, t = Math.max(t, c)
                            }
                            r += t + e
                        }
                        return [n, s]
                        ...
                        const e = [];
                        for (const i of t)
                            for (const t in i) xr(e, t, i[t]);
                        return e
                    }(e);
                    const h = r.map((t => L(t, "offsetHeight") + l * (t.length - 1))),
                        c = Math.max(0, ...h);
                    let d, u, f;
                    return (n || s) && (d = h.map(((t, e) => s ? c - t + n : n / (e % 2 || 8))), s || (n = Math.max(...h.map(((t, e) => t + d[e] - c)))), u = Fe(this.parallaxStart, "height", this.$el, !0), f = Fe(this.parallaxEnd, "height", this.$el, !0)), {
                        columns: r,
                        translates: a,
                        scrollColumns: d,
                        parallaxStart: u,
    ...
    var yr = {
        ...
        update: {
            read() {
                return {
                    rows: (this.row ? wn(this.elements) : [this.elements]).map(Sr)
                }
            },
            write({
                rows: t
                ...
                for (const {
                        heights: e,
                        elements: i
                    } of t) i.forEach(((t, i) => Kt(t, "minHeight", e[i])))
            },
            events: ["resize"]
        }
    };
            ...
            update: {
                read() {
                    ...
                    if (t = "calc(" + (r ? "100vh" : `${o}px`), this.expand) {
                        ...
                        !0 === this.offsetBottom ? t += ` - ${Be(this.$el.nextElementSibling).height}px` : k(this.offsetBottom) ? t += ` - ${this.offsetBottom}vh` : this.offsetBottom && h(this.offsetBottom, "px") ? t += ` - ${P(this.offsetBottom)}px` : I(this.offsetBottom) && (t += ` - ${Be(kt(this.offsetBottom,this.$el)).height}px`)
                    }
                    return t += (e ? ` - ${e}px` : "") + ")", {
                        minHeight: t
                    }
                ...
                this.svg = this.getSvg().then((t => {
                    ...
                    const e = function(t, e) {
                        if (ct(e) || ce(e, "canvas")) {
                            ...
                            return Tr(t, i) ? i : ge(e, t)
                        }
                        const i = e.lastElementChild;
                        return Tr(t, i) ? i : pe(e, t)
                    }(t, this.$el);
                    return this.svgEl && e !== this.svgEl && be(this.svgEl), Er.call(this, e, t), this.svgEl = e
                }), V)
            },
            disconnected() {
                this.svg.then((t => {
    ...
    const _r = {
            ...
            "navbar-toggle-icon": '<svg width="20" height="20" viewBox="0 0 20 20"><style>.bdt-navbar-toggle-animate svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.bdt-navbar-toggle svg&gt;.line-3{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{opacity:1}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-2{transform:rotate(45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-3{transform:rotate(-45deg)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1,.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{opacity:0}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-1{transform:translateY(6px) scaleX(0)}.bdt-navbar-toggle-animate[aria-expanded=&quot;true&quot;] svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect class="line-1" y="3" width="20" height="2"/><rect class="line-2" y="9" width="20" height="2"/><rect class="line-3" y="9" width="20" height="2"/><rect class="line-4" y="15" width="20" height="2"/></svg>',
        ...
        Br = {
            install: function(t) {
                t.icon.add = (e, i) => {
                    ...
                    H(n, ((t, e) => {
                        _r[e] = t, delete qr[e]
                    })), t._initialized && Ce(document.body, (e => H(t.getComponents(e), (t => {
            ...
            methods: {
                async getSvg() {
                    const t = function(t) {
                        return _r[t] ? (qr[t] || (qr[t] = ke((_r[function(t) {
                            return Xe ? N(N(t, "left", "right"), "previous", "next") : t
                        }(t)] || _r[t]).trim())), qr[t].cloneNode(!0)) : null
                    }(this.icon);
        ...
        Ar = {
            ...
            beforeConnect() {
                ...
                this.icon = wt(this.$el, ".bdt-nav-primary") ? `${t}-large` : t
            }
        },
        Dr = {
            extends: Pr,
            ...
            beforeConnect() {
                if (this.icon = rt(this.$el, "bdt-search-icon") && xt(this.$el, ".bdt-search-large").length ? "search-large" : xt(this.$el, ".bdt-search-navbar").length ? "search-navbar" : this.$props.icon, !Q(this.$el, "aria-label"))
                    if (rt(this.$el, "bdt-search-toggle") || rt(this.$el, "bdt-navbar-toggle")) {
        ...
        Mr = {
            ...
            methods: {
                async getSvg() {
                    const t = await Br.methods.getSvg.call(this);
        ...
        Nr = {
            extends: Or,
            beforeConnect() {
                it(this.$el, "bdt-slidenav");
                const t = this.$props.icon;
                this.icon = rt(this.$el, "bdt-slidenav-large") ? `${t}-large` : t
            }
        },
        zr = {
            extends: Or,
        ...
        Hr = {
            ...
            beforeConnect() {
                this.icon = "close-" + (rt(this.$el, "bdt-close-large") ? "large" : "icon")
            }
        },
        Fr = {
            extends: Or,
        ...
        qr = {};
    const Vr = Ue && "loading" in HTMLImageElement.prototype;
    var Rr = {
        args: "dataSrc",
        props: {
            dataSrc: String,
        ...
        connected() {
            "lazy" === this.loading ? (Vr && Jr(this.$el) && (this.$el.loading = "lazy", Ur(this.$el)), function(t) {
                Jr(t) && !Q(t, "src") && K(t, "src", 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"></svg>')
            }(this.$el)) : this.load()
        },
        disconnected() {
        ...
        methods: {
            load() {
                ...
                const t = Jr(this.$el) ? this.$el : function(t, e, i) {
                    const n = new Image;
                    return function(t, e) {
                        if (e = function(t) {
                                if (!t) return [];
                ...
                return tt(t, "loading"), Ur(this.$el, t.currentSrc), this.img = t
            }
        }
    };
    ...
    function Ur(t, e) {
        if (Jr(t)) {
            const e = gt(t);
            (ce(e, "picture") ? yt(e) : [t]).forEach((t => Yr(t, t)))
        } else e && !c(t.style.backgroundImage, e) && (Kt(t, "backgroundImage", `url(${Ft(e)})`), qt(t, Vt("load", !1)))
    }
    const Xr = ["data-src", "data-srcset", "sizes"];
    ...
    var Gr = {
            ...
            computed: {
                fill({
                    ...
                    return t || Kt(this.$el, "--bdt-leader-fill-content")
                }
            },
            connected() {
        ...
        Zr = {
            install: function({
                ...
                t.dialog = function(e, i) {
                    ...
                    return e((({
                        i18n: e
                    }) => `<div class="bdt-modal-body">${I(t)?t:ue(t)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>${e.ok}</button> </div>`), i)
                }, t.confirm = function(t, i) {
                    return e((({
                        i18n: e
                    }) => `<form> <div class="bdt-modal-body">${I(t)?t:ue(t)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${e.cancel}</button> <button class="bdt-button bdt-button-primary" autofocus>${e.ok}</button> </div> </form>`), i, (() => Promise.reject()))
                }, t.prompt = function(t, i, n) {
                    const s = e((({
                            i18n: e
                        }) => `<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>${I(t)?t:ue(t)}</label> <input class="bdt-input" value="${i||""}" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${e.cancel}</button> <button class="bdt-button bdt-button-primary">${e.ok}</button> </div> </form>`), n, (() => null), (() => r.value)),
                        {
                            $el: o
                        } = s.dialog,
                        r = ke("input", o);
            ...
            events: [{
                ...
                self: !0,
                handler() {
                    rt(this.panel, "bdt-margin-auto-vertical") ? it(this.$el, "bdt-flex") : Kt(this.$el, "display", "block"), Me(this.$el)
                }
            }, {
                name: "hidden",
                self: !0,
                handler() {
                    Kt(this.$el, "display", ""), nt(this.$el, "bdt-flex")
                }
            }]
        };
    var Kr = {
        ...
        Qr = {
            ...
            computed: {
                ...
                navbarContainer() {
                    return wt(this.$el, ".bdt-navbar-container")
                }
            },
            watch: {
                items() {
                    const t = rt(this.$el, "bdt-navbar-justify");
                    for (const e of Te(".bdt-navbar-nav, .bdt-navbar-left, .bdt-navbar-right", this.$el)) Kt(e, "flexGrow", t ? Te(".bdt-navbar-nav > li > a, .bdt-navbar-item, .bdt-navbar-toggle", e).length : "")
                }
            },
            disconnect() {
                var t;
            ...
            events: [{
                ...
                handler({
                    ...
                    const i = () => this._mode = function(t, ...e) {
                        for (const i of e)
                            if (rt(t, i)) return nt(t, i), i
                    }(this.navbarContainer, "bdt-light", "bdt-dark");
                    if ("behind" === e) {
                        const t = ta(this.$el);
                        t && (i(), it(this.navbarContainer, `bdt-${t}`))
                    }
                    "remove" === e && (i(), nt(this.navbarContainer, "bdt-navbar-transparent"))
                }
            }, {
                name: "hide",
                el() {
                ...
                async handler({
                    ...
                    const e = this.getTransparentMode(t);
                    if (e && this._mode && (await async function() {
                            return new Promise((t => setTimeout(t)))
                        }(), !this.getActive())) {
                        if ("behind" === e) {
                            const t = ta(this.$el);
                            t && nt(this.navbarContainer, `bdt-${t}`)
                        }
                        it(this.navbarContainer, this._mode), "remove" === e && it(this.navbarContainer, "bdt-navbar-transparent"), this._mode = null
                    }
                }
            }],
            methods: {
                getTransparentMode(t) {
                    ...
                    const e = this.getDropdown(t);
                    return e && rt(t, "bdt-dropbar") ? e.inset ? "behind" : "remove" : void 0
                },
                registerColorListener() {
                    const t = this._isIntersecting && rt(this.navbarContainer, "bdt-navbar-transparent") && ! function(t) {
                        do {
                            if ("normal" !== Kt(t, "mixBlendMode")) return !0
                        } while (t = gt(t))
                    }(this.navbarContainer) && !Te(".bdt-drop", this.dropContainer).map(this.getDropdown).some((t => t.isToggled() && (t.inset || "behind" === this.getTransparentMode(t.$el))));
                    this._colorListener ? t || (this._colorListener(), this._colorListener = null) : t && (this._colorListener = function(t, e) {
                        const i = Pi(t, !0),
                            n = Lt(i === document.documentElement ? document : i, "scroll", e, {
                                passive: !0
                            }),
                            s = di([t, i], e);
                        return () => {
                        ...
                        const {
                            ...
                            top: e,
                            height: i
                        } = Pe(this.navbarContainer), n = {
                            x: t,
                            y: Math.max(0, e) + i / 2
                        }, s = Kt(Te(this.selTransparentTarget).find((t => U(n, Pe(t)))), "--bdt-navbar-color");
                        s && ot(this.navbarContainer, "bdt-light,bdt-dark", `bdt-${s}`)
                    })))
                }
            }
        };
    ...
    function ta(t) {
        return Kt(t, "--bdt-navbar-dropbar-behind-color")
    }
    var ea = {
        mixins: [ts],
        args: "mode",
        ...
        events: [{
            ...
            handler() {
                ...
                it(t, this.clsContainer, this.clsFlip), Kt(t, "touch-action", "pan-y pinch-zoom"), Kt(this.$el, "display", "block"), Kt(this.panel, "maxWidth", e.clientWidth), it(this.$el, this.clsOverlay), it(this.panel, this.clsSidebarAnimation, "reveal" === this.mode ? "" : this.clsMode), Me(t), it(t, this.clsContainerAnimation), this.clsContainerAnimation && (ia().content += ",user-scalable=0")
            }
        }, {
            name: "hide",
            self: !0,
            ...
            handler() {
                ...
                }(), "reveal" === this.mode && xe(this.panel), nt(this.panel, this.clsSidebarAnimation, this.clsMode), nt(this.$el, this.clsOverlay), Kt(this.$el, "display", ""), Kt(this.panel, "maxWidth", ""), nt(document.body, this.clsContainer, this.clsFlip)
            }
        }, {
    ...
    var na = {
            ...
            update: {
                read() {
                    return !!(this.content && this.container && dt(this.$el)) && {
                        max: Math.max(this.minHeight, Me(this.container) - (Be(this.content).height - Me(this.$el)))
                    }
                },
                write({
                    max: t
        ...
        sa = {
            props: ["width", "height"],
            connected() {
                it(this.$el, "bdt-responsive-width")
            },
            observe: hn({
                target: ({
                    $el: t
            ...
            update: {
                read() {
                    return !!(dt(this.$el) && this.width && this.height) && {
                        width: Oe(gt(this.$el)),
                        height: this.height
                    }
                },
                write(t) {
                    Me(this.$el, J.contain({
                        height: this.height,
                        width: this.width
                    }, t).height)
                },
        ...
        oa = {
            ...
            connected() {
                ! function(t) {
                    ra.size || Lt(document, "click", aa), ra.add(t)
                }(this)
            },
            disconnected() {
                ! function(t) {
                    ra.delete(t), ra.size || jt(document, "click", aa)
                }(this)
            },
            methods: {
                async scrollTo(t) {
                    t = t && ke(t) || document.body, qt(this.$el, "beforescroll", [this, t]) && (await Ei(t, {
                        offset: this.offset
                    }), qt(this.$el, "scrolled", [this, t]))
                }
            }
        };
    const ra = new Set;
    ...
    function aa(t) {
        if (!t.defaultPrevented)
            for (const e of ra) $t(t.target, e.$el) && It(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Ct(e.$el)))
    }
    var la = {
            args: "cls",
            props: {
            ...
            observe: cn({
                ...
                handler(t) {
                    ...
                    for (const {
                        ...
                        e.has(i) || e.set(i, {
                            cls: et(i, "bdt-scrollspy-class") || this.cls
                        });
                        const t = e.get(i);
    ...
    var da = {
        ...
        connected() {
            this.start = fa(this.start || this.top), this.end = fa(this.end || this.bottom), this.placeholder = ke("+ .bdt-sticky-placeholder", this.$el) || ke('<div class="bdt-sticky-placeholder"></div>'), this.isFixed = !1, this.setActive(!1)
        },
        beforeDisconnect() {
            this.isFixed && (this.hide(), nt(this.selTarget, this.clsInactive)), pa(this.$el), be(this.placeholder), this.placeholder = null
        },
        observe: [fn(), pn({
        ...
        update: [{
            read({
                ...
                s && (ma(this.selTarget), this.hide()), this.active || (({
                    height: t,
                    width: e
                } = Pe(this.$el)), i = Kt(this.$el, "margin")), s && this.show();
                ...
                const d = this.overflowFlip ? 0 : Math.max(0, t + c - o),
                    u = Pe(h).top,
                    f = Pe(this.$el).height,
                    p = (!1 === this.start ? u : ua(this.start, this.$el, u)) - c,
                    m = !1 === this.end ? a : Math.min(a, ua(this.end, this.$el, u + t, !0) - f - c + d);
                return n = a && !this.showOnUp && p + c === u && m === Math.min(a, ua("!*", this.$el, 0, !0) - f - c + d) && "visible" === Kt(gt(this.$el), "overflowY"), {
                    start: p,
                    end: m,
                    offset: c,
                    overflow: d,
            ...
            write({
                ...
                if ((this.inactive || s || !this.isFixed) && pa(this.$el), this.inactive) return;
                ...
                Kt(o, {
                    ...
                    width: e,
                    margin: i
                }), $t(o, document) || (o.hidden = !0), (s ? me : ge)(this.$el, o)
            },
            events: ["resize"]
        }, {
            read({
                ...
                return {
                    ...
                    scroll: r,
                    prevScroll: t,
                    offsetParentTop: Pe((this.isFixed ? this.placeholder : this.$el).offsetParent).top,
                    overflowScroll: q(n + q(r, s, o) - q(t, s, o), 0, i)
                }
            },
            write(t, e) {
                ...
                if ((u - n > 300 || s !== o) && (t.initScroll = r, t.initTimestamp = u), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10))
                    if (this.inactive || r < h || this.showOnUp && (r <= h || "down" === s && i || "up" === s && !this.isFixed && r <= c + d)) {
                        ...
                        if (this.animation && r > c) {
                            if (rt(this.$el, "bdt-animation-leave")) return;
                            he.out(this.$el, this.animation).then((() => this.hide()), V)
                        } else this.hide()
                    } else this.isFixed ? this.update() : this.animation && r > c ? (this.show(), he.in(this.$el, this.animation).catch(V)) : (ma(this.selTarget), this.show())
            },
        ...
        methods: {
            ...
            hide() {
                ...
                this.setActive(!1), nt(this.$el, this.clsFixed, this.clsBelow), e ? Kt(this.$el, "top", t) : Kt(this.$el, {
                    position: "",
                    top: "",
                    width: "",
                    marginTop: ""
            ...
            update() {
                ...
                if (!d) {
                    let s = "fixed";
                    e > o && (r += o - c + n - i, s = "absolute"), Kt(this.$el, {
                        position: s,
                        width: t,
                        marginTop: 0
                    }, "important")
    ...
    var ga = {
        ...
        async connected() {
            ...
            const t = await this.svg;
            t && (va.call(this, t), this.strokeAnimation && function(t) {
                const e = no(t);
                e && Kt(t, "--bdt-animation-stroke", e)
            }(t))
        },
        methods: {
            async getSvg() {
                return ce(this.$el, "img") && !this.$el.complete && "lazy" === this.$el.loading ? new Promise((t => Wt(this.$el, "load", (() => t(this.getSvg()))))) : function(t, e) {
                    return e && c(t, "<symbol") && (t = $a(t)[e] || t), t = ke(t.substr(t.indexOf("<svg"))), (null == t ? void 0 : t.hasChildNodes()) && t
                }(await ba(this.src), this.icon) || Promise.reject("SVG not found.")
            }
        }
    };
    ...
    const ba = Z((async t => t ? l(t, "data:") ? decodeURIComponent(t.split(",")[1]) : (await fetch(t)).text() : Promise.reject()));
    const wa = /<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g,
        $a = Z((function(t) {
            const e = {};
            let i;
            for (wa.lastIndex = 0; i = wa.exec(t);) e[i[3]] = `<svg ${i[1]}svg>`;
            return e
        }));
    const xa = ".bdt-disabled *, .bdt-disabled, [disabled]";
    var ya = {
            mixins: [Jn],
            args: "connect",
            props: {
            ...
            events: [{
                ...
                handler(t) {
                    !bt(t.current, xa) && ("click" === t.type || t.keyCode === Mn) && (t.preventDefault(), this.show(t.current))
                }
            }, {
                name: "keydown",
                delegate() {
                ...
                handler(t) {
                    ...
                    let s = i === Nn ? 0 : i === On ? "last" : i === zn && !n || i === Hn && n ? "previous" : i === Fn && !n || i === Ln && n ? "next" : -1;
                    if (~s) {
                        t.preventDefault();
                        const i = this.toggles.filter((t => !bt(t, xa))),
            ...
            update() {
                ...
                for (const e in this.toggles) {
                    ...
                    K(i, "role", "tab"), n && (i.id = Rs(this, i, `-tab-${e}`), n.id = Rs(this, n, `-tabpanel-${e}`), K(i, "aria-controls", n.id), K(n, {
                        role: "tabpanel",
                        "aria-labelledby": i.id
                    }))
                }
        ...
        Sa = {
            ...
            connected() {
                const t = rt(this.$el, "bdt-tab-left") ? "bdt-tab-left" : !!rt(this.$el, "bdt-tab-right") && "bdt-tab-right";
    ...
    var Ia = {
        ...
        events: [{
            ...
            handler(t) {
                this._preventClick = null, Jt(t) && !S(this._showState) && !this.$el.disabled && (qt(this.$el, "focus"), Wt(document, Ge, (() => qt(this.$el, "blur")), !0, (t => !$t(t.target, this.$el))), c(this.mode, "click") && (this._preventClick = !0))
            }
        }, {
            ...
            handler(t) {
                ...
                e || !(!S(this._showState) || "blur" !== t.type && bt(this.$el, ":focus") || "blur" === t.type && bt(this.$el, ":hover")) ? e && S(this._showState) && i !== this._showState || (this._showState = e ? i : null, this.toggle("toggle" + (e ? "show" : "hide"))) : i === this._showState && (this._showState = null)
            }
        }, {
            name: "keydown",
            filter() {
            ...
            handler(t) {
                let e;
                (this._preventClick || wt(t.target, 'a[href="#"], a[href=""]') || (e = wt(t.target, "a[href]")) && (!this.isToggled(this.target) || e.hash && bt(this.target, e.hash))) && t.preventDefault(), !this._preventClick && c(this.mode, "click") && this.toggle()
            }
        }, {
            name: "mediachange",
            filter() {
    ...
    return H(Object.freeze({
            ...
            Totop: Lr,
            Video: rr
        }), ((t, e) => Os.component(e, t))),
        function(t) {
            Ue && window.MutationObserver && (document.body ? requestAnimationFrame((() => Go(t))) : new MutationObserver(((e, i) => {
                document.body && (Go(t), i.disconnect())
            })).observe(document.documentElement, {
                childList: !0
            }))
        }(Os), H(Jo, ((t, e) => Os.component(e, t))), Os
}));